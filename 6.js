...
class Basket {
  ...
  calculateTotalPrice() {
    const totalWithoutDiscount = this.goods.reduce((acc, good) => acc + good.price, 0);
    const totalPriceWithDiscount = this.discountPlan.applyDiscount(totalWithoutDiscount);
